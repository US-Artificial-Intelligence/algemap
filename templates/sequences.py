...
class Sequence(Template):
    def generate(self, max_sequence_length=10, min_sequence_length=4, n=10, show_rule=True, show_instructions=False) -> List[Tuple[str, dict]]:
        results = [self.gen_one(max_sequence_length=max_sequence_length, min_sequence_length=min_sequence_length, show_rule=show_rule, show_instructions=show_instructions) for _ in range(n)]
        return results

    def gen_one(self, max_sequence_length=10, min_sequence_length=4, show_rule=False, show_instructions=False):
